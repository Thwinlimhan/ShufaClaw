...
class Reporter:
    ...
    async def build_morning_briefing_data():
        ...
        for p in positions:
            ...
            if price:
                ...
                prev_val = current_val / (1 + (change_pct / 100)) if change_pct else current_val
    ...
    async def generate_briefing_message(data):
        ...
        msg += "🤖 **AI MARKET TAKE**\n"
        msg += "━━━━━━━━━━━━━━━━━━━\n"
        commentary = await Reporter.get_claude_commentary(data)
        msg += f"{commentary}\n\n"
    ...
    async def build_evening_summary_data():
        ...
        outlook = await Reporter.get_tomorrow_outlook()
